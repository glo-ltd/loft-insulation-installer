...
const { LIcons, Button, Card, Badge, WavePanel, SectionHead, Stars, useReveal,
        Calculator, LeadForm, TrustBar, Process, Reviews, WhyPro, CtaBand, Funding, SERVICE_INDEX } = window;
