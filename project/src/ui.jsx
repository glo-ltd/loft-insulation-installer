...
/* ---------- Primitives ---------- */
function Button({ variant = "primary", size = "md", block, onDark, href, onClick, children, type, leftIcon, rightIcon, style, className = "" }) {
  ...
  return <button className={cls} type={type || "button"} onClick={onClick} style={style}>{inner}</button>;
}
...
Object.assign(window, { LIcons: I, Logo, Button, Card, Badge, WavePanel, SectionHead, Stars, useReveal });
