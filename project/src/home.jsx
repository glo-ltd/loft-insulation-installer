...
const { LIcons, Logo, Button, Card, Badge, WavePanel, SectionHead, Stars, useReveal, Calculator, LeadForm } = window;
...
function HomePage({ onNav }) {
  ...
  return (
    <div>
      ...
      <Benefits />
      <WhyPro />
      <Process cta={<window.CtaBand embed onNav={onNav} title="Warmer home. Lower bills. Less waste." text="Join the homeowners across the UK who've made their homes more efficient with an accredited local installer." cta="Get my free quote" />} />
      <Reviews />
      <FAQ />
...
// Reusable sections shared with the service pages.
Object.assign(window, { TrustBar, Process, Reviews, WhyPro, Funding });
