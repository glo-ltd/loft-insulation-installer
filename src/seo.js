...
export const PAGE_META = {
  "home": {
    ...
    title: "Loft Insulation Installers | Free Quote, UK-Wide",
  ...
  "loft-insulation": {
    ...
    description: "Compare eco-friendly loft insulation - sheep wool, foil, recycled plastic & hemp - fitted by accredited local installers. Book your free consultation.",
  ...
  "sheep-wool": {
    ...
    title: "Sheep Wool Loft Insulation Installers | Free Consultation",
  ...
  "recycled-plastic": {
    ...
    ogDescription: "Soft, safe insulation made from thousands of recycled bottles, easy to fit in modern homes. Accredited installers, free no-obligation phone consultation.",
  },
  "hemp": {
  ...
  "loft-storage": {
    ...
    description: "Reclaim your loft with boarding, ladders, hatches and storage rooms, fitted to building-regs standard with your existing insulation kept intact. Get a free quote.",
    ogTitle: "Loft Storage Solutions That Protect Your Insulation",
    ogDescription: "Boarding, ladders, hatches and storage rooms, fitted to building-regs standard with your existing insulation kept intact. Get a free, no-obligation quote.",
  },
  "loft-boarding": {
    ...
    title: "Loft Boarding Installers | Strong, Safe Storage",
    description: "Professional loft boarding fitted over your existing insulation, which is kept intact, for safe, usable storage. Accredited installers. Get a free quote.",
    ogTitle: "Loft Boarding - Safe Storage Over Your Insulation",
    ogDescription: "Turn a dark, unsafe loft into usable storage, with boarding fixed to a subframe over your existing insulation, kept intact. Fitted by accredited installers. Get a free quote.",
  },
  "loft-ladders": {
  ...
  "privacy-policy": {
    ...
    description: "How Loft Insulation Installer collects, uses and protects your personal data when you request a quote or consultation.",
  },
  "cookie-policy": {
