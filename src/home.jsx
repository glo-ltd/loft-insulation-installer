    ...
    <section className="section">
      <div className="wrap intro reveal">
        <div>
          ...
          <p>We're not a faceless trade. We match you with an accredited local installer who consultations your loft, recommends the right sustainable material, and fits it cleanly and correctly, at a fair price.</p>
    ...
    <section className="section" id="insulation-types">
      <div className="wrap">
        <SectionHead eyebrow="Loft insulation" title="Choose your sustainable material." marker
          sub="Four eco-friendly materials, each suited to a different kind of home. Not sure? Our consultation recommends the right one for you." />
...
const STORE_CARDS = [
  { id: "loft-boarding", title: "Loft Boarding", img: "/assets/loft-boarding.jpg", tag: "Reclaim your space", body: "Turn a dark, unsafe loft into safe, usable storage, with boarding fixed to a subframe over your existing insulation, which is kept intact." },
    ...
    <section className="section section--mist" id="storage-services">
      <div className="wrap">
        <SectionHead eyebrow="Loft storage" title="Make more of your loft." marker
          sub="Reclaim unused space, your existing insulation is kept intact. Boarding, ladders, hatches and full storage rooms, fitted to building-regs standard." />
        <div className="svc-grid svc-grid--4">
          {STORE_CARDS.map((s) => {
            return (
...
const WHY = [
  ...
  ["Sparkle", "Tidy, every time", "Hazards assessed before work begins, belongings respected, and everything cleaned up once the job's done."],
];
function WhyPro() {
  const Ic = LIcons;
  return (
...
function Process({ eyebrow = "How it works", title = "A simple, hassle-free process.", sub = "From your first call to a finished job: five clear steps, with reassurance the whole way.", cta = null, installNote = "A standard three-bedroom loft takes around 1 day." }) {
  const STEPS = [
    ["Free phone consultation", "A 20–30 minute call to discuss your home and your needs, recommend the right insulation and why, and give you an initial idea of cost."],
    ["Your quote", "We follow up with a clear, no-obligation quote, with a full cost breakdown and no pressure."],
    ...
    ["Installation", "Your accredited installer completes the work cleanly and tidily." + (installNote ? " " + installNote : "")],
  ];
  return (
...
const FUNDING = {
  ...
  storage: {
    ...
    a: { big: "0", unit: "mm lost", h: "No lost head height", p: "Your existing floor insulation is kept intact, and boarding is fixed to a subframe with multifoil insulation to the rafters, so you gain usable space with no raised floor and no lost head height." },
        ...
        <div className="finalform">
          ...
          <aside className="finalform__aside">
            ...
            <WavePanel color="true-teal" radius="var(--radius-lg)" style={{ padding: 30, color: "#fff" }}>
              ...
              <p style={{ margin: "12px 0 0", color: "rgba(255,255,255,0.92)", fontSize: 15, lineHeight: 1.6 }}>No problem. Tell us your home's age in the form's helper, or just choose "please recommend", and your installer will advise on the best sustainable option during your free phone consultation.</p>
            </WavePanel>
          </aside>
        </div>
      </div>
