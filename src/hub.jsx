    ...
    <WavePanel color="dark-slate" radius="0" className="hero">
      <div className="wrap hero__grid">
        ...
        <div className="hero__media">
          <LeadForm onNav={onNav} compact presetType={d.silo === "loft-storage" ? "Complete Loft Storage Rooms" : ""} title="Get your free quote." sub="Most consultations booked within 48 hours. No obligation." />
        </div>
      </div>
    </WavePanel>
  );
    ...
    <section className="section section--mist" id="quote">
      <div className="wrap">
        ...
        <div className="finalform">
          <LeadForm onNav={onNav} presetType={d.silo === "loft-storage" ? "Complete Loft Storage Rooms" : ""} title="Request your free quote." sub="Takes under a minute. No obligation, ever." />
